...
/* @var $searchModel member\modules\sys\models\search\MemberSearch */
    ...
    <?= GridView::widget([
        ...
        [
            ...
            'value' => function ($model) {
                return \member\modules\sys\models\WechatUser::getNickname($model->openid);
            },
        ],
//            'openid',
            'realname',
			 ...
			 [
                'label'=>'级别',
                'attribute' => 'rank',
                'filter' => \member\modules\sys\models\Member::rank(),
                'value' => function ($model) {
