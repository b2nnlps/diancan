...
/**
 * This is the model class for table "{{%eshop_category}}".
 *
 * @property integer $id
...
class Category extends \common\components\base\BaseActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['name', 'icon', 'brief', 'banner', 'keywords', 'description', 'redirect_url', 'created_by', 'updated_by'], 'string', 'max' => 255],
        ];
    }
