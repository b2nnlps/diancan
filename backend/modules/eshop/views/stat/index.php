            ...
            <div class="accordion acist">
                    <table class="list">
                        <tr>
                            ...
                            <th style="width:10%"><?=$_v['consignee']?></th>
                            <th style="width:10%"><?=$_v['phone']?></th>
                            <th style="width:5%"><?=$_v['amount']?></th>
                            <th style=" width:10%"><?=Order::method($_v['payment_method'])?></th>
                            <th style=" width:5%"><?=Order::payment_status($_v['payment_status'])?></th>
                            <th style=" width:10%"><?=Order::status($_v['status'])?></th>
                            <th style=" width:5%"><?=Order::clearing($_v['clearing'])?></th>
                            <th style=" width:15%"><?=$_v['created_time']?></th>
                        </tr>
                    </table>
            </div>
