...
/**
 * AddressSearch represents the model behind the search form about `backend\modules\merchant\models\Address`.
 */
class AddressSearch extends Address
{
    ...
    public function rules()
    {
        return [
            ...
            [['rh_openid', 'consignee', 'phone', 'address', 'zipcode', 'operator', 'created_time', 'updated_time'], 'safe'],
        ];
    }
