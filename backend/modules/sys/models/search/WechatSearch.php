...
/**
 * WechatSearch represents the model behind the search form about `backend\modules\sys\models\Wechat`.
 */
class WechatSearch extends WechatUser
{
    ...
    {
        return [
            [['openid', 'nickname', 'headimgurl', 'address','wechat', 'subscribe_time','updated_time', 'remark'], 'safe'],
