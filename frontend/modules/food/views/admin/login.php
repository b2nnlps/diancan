...
<body>
  ...
  <form id="contact" method="post">
    <h3>员工登录</h3>
    <h4>输入系统设置的账号和密码，获取权限</h4>
    <fieldset>
      <input placeholder="员工账号" type="text" name="username" tabindex="1" required autofocus>
    </fieldset>
    <fieldset>
      <input placeholder="员工密码" type="password" name="password" tabindex="2" required>
    </fieldset>
