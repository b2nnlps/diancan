...
if($rank==1){
    $url='http://ms.n39.cn/merchant/good/product-list?sid='.$supplierID;
}else{
    $url='http://ms.n39.cn/merchant/default/product-list?sid='.$supplierID;
}
...
//                alert(data);
            ...
            $('.order').click(function() {
                ...
                if(number==='0'){
                    ...
                    window.location.href="<?=Yii::$app->urlManager->createAbsoluteUrl(['merchant/order/cart','sid'=>$supplierID])?>";
                }
            });
...
<div class="box"><!--头部：开始--->
    <div class="Favorites">
        <ul>
            ...
            <p><?=$supplier['name']?></p>
              <li><a href="#" style=" font-size:14px;color:#FE4543;" onclick="check()">
                    推广
                    <!--<img src="icon/tgimg.png">-->
                </a></li>
            <div class="clear"></div>
        </ul>
    </div>
...
<!--点击后出现遮罩层 并且有图片指向-->
<div onclick="checkhd()" id="ceng" style="display:none; position:fixed; top:0px; left:0px; background-color:black; width:100%; height:100%; filter:alpha(opacity=30);-moz-opacity:0.30;opacity:0.80;">
    <div style="width:100%; height:100%;color:white;margin:auto 0px; text-align:center;"><img src="<?=Yii::$app->view->theme->baseUrl?>/merchant_v1.0/icon/fx.png"></div>
</div>
