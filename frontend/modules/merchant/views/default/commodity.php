...
<head>
    ...
    <script>
        ...
        var dataForShare={
            ...
            weixin_url:"http://ms.n39.cn/merchant/default/commodity?aid="+<?=$model['id']?>,
            weibo_icon:"<?=$product['thumb']?>",
            url:"http://ms.n39.cn/merchant/default/commodity?aid="+<?=$model['id']?>,
            title:"<?=$product['name']?>",
...
<!--                </dd>-->
        ...
        <div class="Business">
            <a href="<?= Yii::$app->urlManager->createAbsoluteUrl(['merchant/default/product-list', 'sid' => $supplier['id']]) ?>">
                <dl>
                    <dt>
