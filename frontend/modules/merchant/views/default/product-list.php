...
<head>
    ...
    <script>
        ...
        var dataForShare={
            ...
            weixin_url:"http://ms.n39.cn/merchant/default/product-list?sid="+<?=$supplier['id']?>,
            weibo_icon:"<?=$supplier['logo']?>",
            url:"http://ms.n39.cn/merchant/default/product-list?sid="+<?=$supplier['id']?>,
            title:"<?=$supplier['name']?>",
    ...
    <div class="main" style=" margin-top:0;">
        ...
        <div id="woaicss_con1" style="display:block;">
            <div class="list">
                ...
                ?>
                <dl>
                    <a href="<?=Yii::$app->urlManager->createAbsoluteUrl(['merchant/default/commodity','aid'=>$_v['id']])?>">
