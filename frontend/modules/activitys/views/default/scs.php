...
<div class="box">
    <div class="Favorites">
        <ul class="clearfix">
            <li><a href="<?= Yii::$app->urlManager->createAbsoluteUrl(['activitys/default/apply','aid'=>6]) ?>"><img src="<?=Yii::$app->view->theme->baseUrl?>/hdb_v1.0/icon/home.png" width="20" height="20"></a></li>
            <p>提交审核</p>
            <li></li>
        </ul>
    </div>
